...
<head>
	<meta charset="utf-8" />
	<title>CV.Archindo Media Karya</title>
        ...
        <div class="login login-with-news-feed">
            ...
            <div class="news-feed">
                ...
                <div class="news-caption">
                    <h4 class="caption-title"><i class="fa fa-diamond text-success"></i>cv.Archindo Media Karya</h4>
                    <p>
            ...
            <div class="right-content">
                ...
                <div class="login-header">
                    <div class="brand">
                        <span class="logo"></span> APP Penggajian
                        <small> cv.Archindo Media Karya</small>
                    </div>
                    <div class="icon">
