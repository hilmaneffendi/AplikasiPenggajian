<?php
	 ...
	 if ($cek>0) {
		...
		if ($_FILES['imagefile']['type'] == "image/jpeg"){
					...
					VALUES ('".$_POST['username']."','".md5($_POST['password'])."','".$_POST['level']."','".$_FILES['imagefile']['name']."','".$_POST['nip']."')";
					...
					$sql="INSERT INTO `tb_pengguna`(`username`, `password`, `level`, `imagefile`, `nip`)
					VALUES ('".$_POST['username']."','".md5($_POST['password'])."','".$_POST['level']."','default.jpg','".$_POST['nip']."')";
					mysql_query($sql) or die("Data sudah ada!");
					header ("location:../index.php?p=data_pengguna");
				}
	 }
